...
public class Test_20181003114101_create_sp_mc_prp_actualiza_movimiento_estado_negocio_v10 extends TestDbBasePg {
  private static final String SP_NAME = SCHEMA + ".mc_prp_actualiza_movimiento_estado_negocio_v10";
  ...
  public void updateMovementsOk() throws SQLException {
    ...
    Assert.assertEquals("El estado debe ser REVERSED", "REVERSED", fila.get("estado_de_negocio"));
  }
