...
public class Test_20190219142133_create_sp_mc_expire_old_reconciliation_movements_v10 extends TestDbBasePg {
  ...
  public void expireOldReconciledMovements() throws SQLException, InterruptedException {
    ...
    for(int i = 0; i < 5; i++) {
      ...
      Test_20190219142005_create_sp_insert_intermediate_reconciliation_files.insertArchivoReconcialicionLog(String.format("FileName%d_1", i), "SWITCH", "SWITCH_TOPUP", "OK");
      Test_20190219142005_create_sp_insert_intermediate_reconciliation_files.insertArchivoReconcialicionLog(String.format("FileName%d_2", i), "SWITCH", "SWITCH_REJECTED_TOPUP", "OK");
      Test_20190219142005_create_sp_insert_intermediate_reconciliation_files.insertArchivoReconcialicionLog(String.format("FileName%d_3", i), "SWITCH", "SWITCH_REVERSED_TOPUP", "OK");
      Test_20190219142005_create_sp_insert_intermediate_reconciliation_files.insertArchivoReconcialicionLog(String.format("FileName%d_4", i), "SWITCH", "SWITCH_WITHDRAW", "OK");
      Test_20190219142005_create_sp_insert_intermediate_reconciliation_files.insertArchivoReconcialicionLog(String.format("FileName%d_5", i), "SWITCH", "SWITCH_REJECTED_WITHDRAW", "OK");
      Test_20190219142005_create_sp_insert_intermediate_reconciliation_files.insertArchivoReconcialicionLog(String.format("FileName%d_6", i), "SWITCH", "SWITCH_REVERSED_WITHDRAW", "OK");
      Test_20190219142005_create_sp_insert_intermediate_reconciliation_files.insertArchivoReconcialicionLog(String.format("FileName%d_7", i), "TECNOCOM", "TECNOCOM_FILE", "OK");
  ...
  @Test
  public void donot_expireOldReconciledMovements() throws SQLException, InterruptedException {
    ...
    for(int i = 0; i < 5; i++) {
      // Insertar los archivos en estado distinto de OK
    ...
    // Nada deberia cambiar puesto que ninguno archivo esta con estado OK
    for(int i = 0; i < okMovements.size(); i++) {
      Map<String, Object> movement = okMovements.get(i);
      Map<String, Object> storedMovement = getMovement(numberUtils.toLong(movement.get("_id")));
      Assert.assertEquals("Debe tener el mismo id", movement.get("_id").toString(), storedMovement.get("id").toString());
