...
-- // create_sp_prp_busca_archivo_reconciliacion_v11
-- Migration SQL that makes the change goes here.

CREATE OR REPLACE FUNCTION ${schema}.prp_busca_archivo_conciliacion_v11
(
    IN _in_id                 BIGINT,
...
DROP FUNCTION IF EXISTS ${schema}.prp_busca_archivo_conciliacion_v11(BIGINT,VARCHAR,VARCHAR,VARCHAR,VARCHAR);
