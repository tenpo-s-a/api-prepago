...
-- // create_sp_mc_prp_buscar_movimientos_v11
-- Migration SQL that makes the change goes here.

CREATE OR REPLACE FUNCTION ${schema}.mc_prp_buscar_movimientos_v11(
  IN _in_id                   BIGINT,
...
DROP FUNCTION IF EXISTS ${schema}.mc_prp_buscar_movimientos_v11(BIGINT, BIGINT, BIGINT, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, VARCHAR, NUMERIC, NUMERIC,  NUMERIC, DATE, VARCHAR,VARCHAR);
