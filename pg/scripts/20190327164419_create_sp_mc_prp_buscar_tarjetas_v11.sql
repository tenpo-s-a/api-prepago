...
-- // create_sp_mc_prp_buscar_tarjetas_v11
-- Migration SQL that makes the change goes here.

CREATE OR REPLACE FUNCTION ${schema}.mc_prp_buscar_tarjetas_v11
(
  IN _in_id              BIGINT,
...
BEGIN
  ...
  WHERE
    ...
    (TRIM(COALESCE(_in_pan_encriptado,'')) = '' OR pan_encriptado = _in_pan_encriptado) AND
...
DROP FUNCTION IF EXISTS ${schema}.mc_prp_buscar_tarjetas_v11(BIGINT, BIGINT, INTEGER, VARCHAR, VARCHAR,VARCHAR);
