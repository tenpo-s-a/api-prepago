...
VALUES
 ('api-prepaid',
  ...
  'v1.0',
  '{"value":"<!DOCTYPE html><html><head> </head><body><p>&nbsp;</p> <h1>Error en el proceso {process}</h1> <h2>Usuario: {nombres}</h2> <h2>Rut: {rut}</h2> <h2>ID Usuario: {IdUsuario}</h2> <h2>N&deg; Autorizacion: {IdUsuario}</h2> <h2>Monto: {monto}</h2> <h3>&nbsp;</h3> <h3>! Importante &iexcl;</h3> <p>Instruccciones para primera vez</p> <ol> <li>asd</li> <li>asd</li> </ol> <p>Instruccciones para segunda vez</p> <ol> <li>asd</li> <li>asd</li> </ol></body></html>"}',
   3600000,
   timezone('utc', now())
 );
...
VALUES
 ('api-prepaid',
  ...
  'v1.0',
  '{"value":"<!DOCTYPE html><html><head> </head><body><p>&nbsp;</p> <h1>Error en el proceso {process}</h1> <h2>Usuario: {nombres}</h2> <h2>Rut: {rut}</h2> <h2>ID Usuario: {IdUsuario}</h2> <h3>&nbsp;</h3> <h3>! Importante &iexcl;</h3> <p>Instruccciones para primera vez</p> <ol> <li>asd</li> <li>asd</li> </ol> <p>Instruccciones para segunda vez</p> <ol> <li>asd</li> <li>asd</li> </ol></body></html>"}',
   3600000,
   timezone('utc', now())
 );
