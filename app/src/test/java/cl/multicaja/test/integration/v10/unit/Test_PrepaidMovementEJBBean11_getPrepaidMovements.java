...
public class Test_PrepaidMovementEJBBean11_getPrepaidMovements extends TestBaseUnit {
  ...
  public void getPrepaidMovement_allOK() throws Exception {
    ...
    PrepaidMovement10 movement = buildPrepaidMovement11(prepaidUser10, topup, card, null, PrepaidMovementType.TOPUP);
    ...
    PrepaidMovement10 movement2 = buildPrepaidMovement11(prepaidUser10, topup, card, null, PrepaidMovementType.TOPUP);
    ...
    PrepaidMovement10 movement3 = buildPrepaidMovement11(prepaidUser10, topup, card, null, PrepaidMovementType.WITHDRAW);
