...
public class Test_PrepaidMovementEJBBean10_updatePendingPrepaidMovementsSwitchStatus extends TestBaseUnit {
  ...
  public void testUpdateMovementBadRequest4() throws Exception {
    getPrepaidMovementEJBBean10().updatePendingPrepaidMovementsSwitchStatus(null, "20180803", "20180803", TipoFactura.CARGA_TRANSFERENCIA, null, null);
  }

  @Test(expected = BadRequestException.class)
  public void testUpdateMovementBadRequest5() throws Exception {
    getPrepaidMovementEJBBean10().updatePendingPrepaidMovementsSwitchStatus(null, "20180803", "20180803", TipoFactura.CARGA_TRANSFERENCIA, IndicadorNormalCorrector.NORMAL, null);
  }

  @Test(expected = BadRequestException.class)
  public void testUpdateMovementBadRequest6() throws Exception {
    getPrepaidMovementEJBBean10().updatePendingPrepaidMovementsSwitchStatus(null, "2018003", "20180803", TipoFactura.CARGA_TRANSFERENCIA, IndicadorNormalCorrector.NORMAL, null);
  }

  @Test(expected = BadRequestException.class)
  public void testUpdateMovementBadRequest7() throws Exception {
    getPrepaidMovementEJBBean10().updatePendingPrepaidMovementsSwitchStatus(null, "20180803", "2018-08-03", TipoFactura.CARGA_TRANSFERENCIA, IndicadorNormalCorrector.NORMAL, null);
  }
