...
public class Test_AccountEJBBean10_findByUuid extends TestBaseUnit {
  ...
  public void findByUuid_accountId_null() throws Exception {
    try {
  ...
  public void findByUuid_account_null() throws Exception {
    try {
      getAccountEJBBean10().findByUuid(getRandomNumericString(5));
  ...
  public void findByUuid() throws Exception {
    ...
    Assert.assertEquals("Debe ser la misma tarjeta", accountNumber, dbAccount.getAccountNumber());
  }
}
