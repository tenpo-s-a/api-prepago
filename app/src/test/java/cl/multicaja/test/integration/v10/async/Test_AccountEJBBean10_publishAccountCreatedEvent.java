...
public class Test_AccountEJBBean10_publishAccountCreatedEvent extends TestBaseUnitAsync {
  ...
  public void publishAccountCreatedEvent() throws Exception {
    ...
    Account account = getAccountEJBBean10().insertAccount(getRandomNumericString(15), prepaidUser10.getId());

    getAccountEJBBean10().publishAccountCreatedEvent(account);
    ...
    Assert.assertEquals("Debe tener el mismo userId", account.getUserId().toString(), accountEvent.getUserId());
  }
