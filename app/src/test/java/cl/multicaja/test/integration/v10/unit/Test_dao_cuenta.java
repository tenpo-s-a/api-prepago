...
public class Test_dao_cuenta extends TestBaseUnit {
  ...
  public void testUpdate() {
    ...
    Cuenta cuenta3 = cuentaDao.find(cuenta.getId());
    ...
    Assert.assertEquals("Cuenta Deben ser igules",cuenta.getCuenta(),cuenta3.getCuenta());
