...
public class Test_PrepaidMovementEJBBean10_updatePendingPrepaidMovementsTecnocomStatus extends TestBaseUnit {
  ...
  public void updateOk() throws  Exception {
    ...
    prepaidMovement10.setConTecnocom(ConciliationStatusType.CONCILIADO);
    prepaidMovement10 = createPrepaidMovement10(prepaidMovement10);
    ...
    getPrepaidMovementEJBBean10().updatePendingPrepaidMovementsTecnocomStatus(null, "20180705", "20180705", TipoFactura.CARGA_TRANSFERENCIA, IndicadorNormalCorrector.NORMAL, ConciliationStatusType.NO_CONCILIADO);
