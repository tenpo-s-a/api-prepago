...
public class PrepaidMovementEJBBean10 extends PrepaidBaseEJBBean10 implements PrepaidMovementEJB10 {
  ...
  public PrepaidMovement10 insertMovement(Long userId, String accountNumber, PrepaidMovement10 movement) throws  BaseException{
    if(userId == null){
  ...
  public PrepaidMovement10 findById(Long id) throws  BaseException{
    if(id == null){
      throw new BadRequestException(PARAMETRO_FALTANTE_$VALUE).setData(new KeyValue("value", "id"));
    }
