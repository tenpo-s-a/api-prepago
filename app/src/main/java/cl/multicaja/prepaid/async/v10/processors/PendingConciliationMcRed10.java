     ...
     try {
       for (ConciliationMcRed10 recTmp : lstReconciliationMcRed10s) {
         ...
         if (prepaidMovement10 == null) {
           ...
           getRoute().getPrepaidMovementEJBBean10().updateStatusMovementConSwitch(null, prepaidMovement10.getId(), ConciliationStatusType.NO_CONCILIATE);
           ...
           continue;
            ...
            log.info("Conciliado");
            getRoute().getPrepaidMovementEJBBean10().updateStatusMovementConSwitch(null, prepaidMovement10.getId(), ConciliationStatusType.CONCILATE);
         }
       }
     }catch (Exception e){
