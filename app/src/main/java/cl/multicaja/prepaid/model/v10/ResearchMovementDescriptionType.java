...
public enum ResearchMovementDescriptionType {
  ...
  NOT_RECONCILIATION_TO_SWITCH("NO_CONCILIADO_CONTRA_SWITCH"),
  ERROR_STATUS_IN_DB("ERROR_DE_ESTADO_EN_BBDD"),
  MOVEMENT_REJECTED_IN_AUTHORIZATION("MOVIMIENTO_RECHAZADO_EN_AUTORIZACION"),
  MOVEMENT_NOT_FOUND_IN_DB("MOVIMIENTO_NO_ENCONTRADO_EN_BBDD"),
  MOVEMENT_NOT_FOUND_IN_FILE("MOVIMIENTO_NO_ENCONTRADO_EN_ARCHIVO"),
  MOVEMENT_WAS_PROCESSED("MOVIMIENTO_FUE_PROCESADO"),
